      ...
      <div className="px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl about-section lg:p-10 2xl:p-13">
        ...
        <div className="mt-7 md:mt-10 section-title">
          ...
          <p className="max-w-2xl mt-4 md:mt-6 subtitle">
            ...
            a technology enthusiast with experience in various areas.
            Previously, I worked on significant projects <span className="text-black dark:text-white">automating accounting processes</span>, using <span className="text-black dark:text-white">microservices</span> with  <span className="text-black dark:text-white">Python and Django </span>
            and implementing <span className="text-black dark:text-white">CI/CD</span> practices with Docker and GitHub Actions. 
            Outside of work, I'm always eager to learn new technologies and techniques to enhance my knowledge 📚. 
            In my leisure time, I'm a sci-fi movie fan 🎬 and can't resist a delicious coxinha 🍗. 
            I'm available to collaborate on new challenges and projects. If you need more information, feel free to reach out!
          </p>
        </div>
